...
// Rotas
app.get('/', userController.getAllUsers); // Define uma rota GET para a raiz ('/'), que chama a função 'getAllUsers' do controlador 'userController' para exibir todos os usuários.
...
// Iniciar o servidor
app.listen(3000, () => { // Inicia o servidor na porta 2000.
    console.log('http://localhost:3000'); // Exibe uma mensagem no console indicando que o servidor está em execução.
});